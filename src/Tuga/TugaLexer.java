...
public class TugaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"BOOLEAN", "PRINT", "INICIO", "FIM", "WHILE", "IF", "ELSE", "PLUS", "MINUS", 
			"MUL", "DIV", "MOD", "E", "OU", "NAO", "MENOR", "MAIOR", "MENORIGUAL", 
			"MAIORIGUAL", "IGUAL", "DIFERENTE", "LPAREN", "RPAREN", "SEMICOLON", 
			"INT", "DOUBLE", "STRING", "ID", "WS", "SL_COMMENT", "ML_COMMENT"
		};
	}
